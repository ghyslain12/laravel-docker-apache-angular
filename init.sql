...
--
-- Hôte : db
-- Généré le : ven. 21 mars 2025 à 21:31
...
INSERT INTO `customers` (`id`, `surnom`, `user_id`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `materials` (`id`, `designation`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `material_sale` (`id`, `created_at`, `updated_at`, `sale_id`, `material_id`) VALUES
(NULL, NULL, NULL, 11, 1),
(NULL, NULL, NULL, 10, 1),
(NULL, NULL, NULL, 12, 1),
(NULL, NULL, NULL, 15, 1),
...
INSERT INTO `sales` (`id`, `titre`, `description`, `customer_id`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `sale_ticket` (`id`, `created_at`, `updated_at`, `sale_id`, `ticket_id`) VALUES
(10, NULL, NULL, 10, 13),
(11, NULL, NULL, 11, 14),
(12, NULL, NULL, 12, 15),
(15, NULL, NULL, 16, 17),
...
INSERT INTO `tickets` (`id`, `titre`, `description`, `created_at`, `updated_at`) VALUES
...
--
ALTER TABLE `customers`
  ADD CONSTRAINT `customers_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `sales`
--
ALTER TABLE `sales`
  ADD CONSTRAINT `sales_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
